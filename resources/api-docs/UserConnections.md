---
url: "https://developers.pipedrive.com/docs/api/v1/UserConnections"
...
[GET\\
\\
Get all user connections](https://developers.pipedrive.com/docs/api/v1/UserConnections#getUserConnections)
