---
url: "https://developers.pipedrive.com/docs/api/v1/Currencies"
...
[GET\\
\\
Get all supported currencies](https://developers.pipedrive.com/docs/api/v1/Currencies#getCurrencies)
