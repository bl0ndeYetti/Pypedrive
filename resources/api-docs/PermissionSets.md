---
url: "https://developers.pipedrive.com/docs/api/v1/PermissionSets"
...
[GET\\
\\
Get all permission sets](https://developers.pipedrive.com/docs/api/v1/PermissionSets#getPermissionSets)

[GET\\
\\
Get one permission set](https://developers.pipedrive.com/docs/api/v1/PermissionSets#getPermissionSet)

[GET\\
\\
List permission set assignments](https://developers.pipedrive.com/docs/api/v1/PermissionSets#getPermissionSetAssignments)
